...
class Results(SimpleClass):
    ...
    def __init__(
        self, orig_img, path, names, boxes=None, masks=None, probs=None, keypoints=None, obb=None, speed=None, embeds=None
    ) -> None:
        """
        ...
        Args:
            ...
            embeds (torch.Tensor | None): A 2D tensor of embeddings for each detection.
